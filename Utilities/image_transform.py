...
def convert_all(base):
    ...
    for i in range(8):
        ...
        try:
            ...
            pass
        try:
            run_conversion(f'{dir}ArmedAgent{i}', base, target)
        except:
            pass
        try:
            ...
            pass
        try:
            run_conversion(f'{dir}GoodAgent{i}', base, target)
        except:
            pass
...
def recolour(path):
    for file in listdir(path):
        ...
        data = []
        for pixel in im.getdata():
            if pixel in ((195, 195, 195, 255), (140, 255, 251, 255)):
                data.append((0, 168, 243, 255))
            elif pixel == (255, 255, 255, 255):
                data.append((140, 255, 251, 255))
            elif pixel == (136, 0, 27, 255):
                data.append((251, 107, 45, 255))
            else:
                data.append(pixel)
...
#for i in range(8):
#    recolour(f'C:\\Users\\brent\\PycharmProjects\\AgentGlitch\\Assets\\Sprites\\GoodAgent{i}')